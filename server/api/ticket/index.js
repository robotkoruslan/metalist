...
router.get('/accessCode/:accessCode', controller.getOneTicketPdfByByAccessCode);
router.get('/', auth.isAuthenticated(), controller.getMyTickets);

router.get('/abonticket/print/:accessCode', controller.print);
router.get('/abonticket/:accessCode', auth.hasRole('cashier' || 'api'), controller.getTicketByAccessCode);
...
router.get('/amount-sold-tickets', auth.hasRole('steward'), controller.getTicketsAmountSold);
